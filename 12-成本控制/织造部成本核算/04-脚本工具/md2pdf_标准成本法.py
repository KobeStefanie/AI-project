...
def md_to_pdf(input_md, output_pdf):
    ...
    for line in content_lines:
        ...
        if in_code_block:
            if stripped:
                story.append(Paragraph(clean_text(stripped), code_style))
            continue
...
if __name__ == '__main__':
    input_md = '../01-学习资料/标准成本法在混乱现场的实际应用.md'
    output_pdf = '../01-学习资料/标准成本法在混乱现场的实际应用.pdf'
