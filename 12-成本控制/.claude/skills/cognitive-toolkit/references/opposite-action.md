...
A 4-step DBT emotion regulation technique from Marsha Linehan's Dialectical Behavior Therapy (Linehan, 1993). Based on the principle that emotions are maintained by their action urges ¡ª and that acting opposite to those urges, all the way, changes the emotional experience itself.

Session duration: 3¨C5 minutes in Telegram exchange format.
...
- User is experiencing a strong emotion with a clear action urge ¡ª and the situation doesn't warrant the full force of that urge
...
**Zone: Supportive** ¡ª gentle pushback only (max 1 exchange)
...
- **Multiple emotions**: "Which one has the strongest pull right now ¡ª which one is driving?"
- **Thought instead of feeling** ("I feel like he doesn't care"): "That sounds like a thought about the situation. What's the *feeling* underneath it ¡ª the emotion in your body?"

**Affect labeling support** (same families as Thought Record ¡ª use to help user get specific):
...
**Zone: Core** ¡ª pushback applies fully

**Prompt:**
> "What does that emotion make you *want* to do? The urge ¡ª even if you haven't acted on it yet."

**Follow-ups:**

- **Thought instead of action** ("I want things to be different"): "That's more of a wish. What do you feel *pulled to do* ¡ª what does the emotion want you to act on?"
...
**Emotion-urge reference table** (for bot's internal use ¡ª do not recite to user unprompted; use to probe or reflect back):
...
**Zone: Core** ¡ª key pushback zone. This is the dialectical pivot.

**Prompt:**
> "Is this urge justified by the *facts* of the situation? Not by the feeling ¡ª by what's actually happening."

**Key principle:** The emotion is always valid. The action urge may or may not be justified by the facts.

**If justified:**
> "OK, so the urge makes sense here. Acting on it isn't opposite action ¡ª it's appropriate. What would be a *skillful* version of acting on it?"
(Exit the technique here ¡ª help them act skillfully rather than act opposite.)
...
- **Level 1¨C2:** "Is the *intensity* of the urge proportional to what actually happened ¡ª or is it larger than the situation warrants?"
- **Level 3:** "Notice what just happened ¡ª the emotion is building a case for the urge. That's what emotions do. They're very convincing. But is the case based on the facts, or on the feeling?"
...
> "What's the opposite of [their action urge]? Not the extreme opposite ¡ª just a move in the *other* direction."
...
| Fear | Avoid, cancel | Approach what you're avoiding ¡ª even a small step |
| Fear | Over-prepare | Act before you feel "ready enough" |
| Sadness | Withdraw, stay in bed | Get active ¡ª walk, call someone, do one thing |
...
> "Do the opposite action *all the way*. Half-measures don't work ¡ª they often maintain the emotion instead of changing it."
